...
const labelClass = "mb-2 block text-[15px] font-black text-slate-800";
const inputClass =
  "w-full rounded-2xl border border-slate-300 bg-white px-4 py-3.5 text-[16px] font-bold text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-[#1F6FB2] focus:ring-4 focus:ring-[#1F6FB2]/12";
const textareaClass =
  "w-full rounded-2xl border border-slate-300 bg-white px-4 py-3.5 text-[16px] font-bold leading-7 text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-[#1F6FB2] focus:ring-4 focus:ring-[#1F6FB2]/12";
const darkLabelClass = "mb-2 block text-[15px] font-black text-slate-100";
const darkInputClass =
  "w-full rounded-2xl border border-white/10 bg-[#061827]/70 px-4 py-3.5 text-[16px] font-bold text-white outline-none transition placeholder:text-slate-400 focus:border-sky-200/55 focus:ring-4 focus:ring-sky-300/12";
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#1F6FB2_0%,#0B1728_42%,#07111F_100%)] px-4 py-6 pb-28 text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-5">
          <section className="rounded-[30px] border border-sky-200/18 bg-white/[0.08] p-5 shadow-[0_18px_44px_rgba(15,23,42,0.22)] backdrop-blur">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-[15px] leading-6 text-slate-200/82">
            ...
            <label className="block">
              <span className={darkLabelClass}>Nome pubblico *</span>
              <input
                required
                value={nomePubblico}
          ...
          <section className="rounded-[30px] border border-cyan-200/70 bg-cyan-50 p-5 text-slate-950 shadow-[0_14px_34px_rgba(15,23,42,0.12)]">
            <h2 className="text-[22px] font-black text-slate-950">Contatti</h2>
            <p className="mt-2 text-[16px] leading-7 text-slate-700">
              Email e telefono non saranno pubblicati nello Spazio Studenti.
              Servono solo per eventuale ricontatto.
            </p>
          ...
          <section className="rounded-[30px] border border-purple-200/70 bg-purple-50 p-5 text-slate-950 shadow-[0_14px_34px_rgba(15,23,42,0.12)]">
            <h2 className="text-[22px] font-black text-slate-950">
              Il caso da condividere
            </h2>
            <p className="mt-2 text-[16px] leading-7 text-slate-700">
              Scrivi il dubbio in modo semplice: cosa hai già fatto, cosa
              vorresti capire e cosa ti blocca.
            </p>
            ...
            <label className="mt-4 block">
              <span className={labelClass}>Titolo del caso *</span>
              <input
                required
                value={titolo}
            ...
            <label className="mt-4 block">
              <span className={labelClass}>Racconta la situazione *</span>
              <textarea
                required
                value={contenuto}
          ...
          <section className="rounded-[30px] border border-white/10 bg-white/[0.08] p-5 shadow-[0_18px_44px_rgba(15,23,42,0.22)] backdrop-blur">
            <label className="flex items-start gap-3">
              ...
              />
              <span className="text-[15px] leading-6 text-slate-100/88">
