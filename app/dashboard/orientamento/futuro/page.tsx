...
const profileResults: Record<ProfileKey, ProfileResult> = {
  STRATEGICO_PROFESSIONALE: {
    ...
    frase:
      "Cerchi una direzione concreta, utile e capace di aprire opportunità reali.",
    descrizione:
  ...
  RELAZIONALE_SOCIALE: {
    ...
    frase:
      "Ti muovi meglio quando al centro ci sono persone, ascolto e relazioni.",
    descrizione:
  ...
  NORMATIVO_ISTITUZIONALE: {
    ...
    frase:
      "Hai bisogno di una strada chiara, riconoscibile e con regole comprensibili.",
    descrizione:
  ...
  CREATIVO_COMUNICATIVO: {
    ...
    frase:
      "Hai bisogno di una direzione in cui idee, linguaggio e identità abbiano spazio.",
    descrizione:
  ...
  EDUCATIVO_FORMATIVO: {
    nome: "Profilo Guida",
    frase:
      "Ti realizzi quando puoi aiutare qualcuno a crescere, capire o migliorare.",
    descrizione:
  ...
  ESPLORATIVO_GUIDATO: {
    ...
    frase:
      "Hai diverse possibilità davanti e hai bisogno di metterle in ordine.",
    descrizione:
...
const questions: Question[] = [
  {
    ...
    options: [
      {
        label: "Vorrei costruire qualcosa di più solido per il lavoro",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Vorrei sentirmi più utile per le persone intorno a me",
        scores: { RELAZIONALE_SOCIALE: 3, EDUCATIVO_FORMATIVO: 1 },
      },
      {
        label: "Vorrei avere una strada chiara, con passaggi precisi",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Vorrei esprimere meglio idee, interessi e capacità",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Vorrei capire prima quali possibilità sono davvero adatte a me",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Quando devo organizzare, decidere e raggiungere un obiettivo",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Quando devo ascoltare, aiutare o comprendere qualcuno",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Quando devo interpretare regole, criteri o procedure",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Quando devo analizzare informazioni, problemi o dati",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Quando devo spiegare qualcosa e renderlo più semplice",
        scores: { EDUCATIVO_FORMATIVO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Ho bisogno di una scelta utile, non solo interessante",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Mi interessa capire meglio me stesso e gli altri",
        scores: { RELAZIONALE_SOCIALE: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Voglio un titolo che abbia valore e riconoscibilità",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Ho molti interessi e non so ancora quale pesi di più",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
      {
        label: "Mi piace costruire contenuti, idee o messaggi",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
    ],
  },
  {
    ...
    sezione: "Istinto iniziale",
    domanda:
      "Quando qualcosa ti interessa davvero, cosa ti viene naturale fare?",
    options: [
      {
        label: "Capire come può diventare un’opportunità concreta",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Approfondire, cercare collegamenti e ragionare sui dettagli",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Raccontarlo, condividerlo o trasformarlo in un progetto",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Usarlo per aiutare o orientare altre persone",
        scores: { EDUCATIVO_FORMATIVO: 3, RELAZIONALE_SOCIALE: 1 },
      },
      {
        label: "Confrontarlo con altre possibilità prima di decidere",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    domanda:
      "Quando devi prendere una decisione importante, cosa ti pesa di più?",
    options: [
      {
        label: "Non sapere se quella scelta porterà risultati reali",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Temere di non essere abbastanza preparato",
        scores: { ESPLORATIVO_GUIDATO: 2, EDUCATIVO_FORMATIVO: 1 },
      },
      {
        label: "Non capire bene regole, requisiti o passaggi",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Dover rinunciare a una parte creativa o personale",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Avere troppe opzioni simili e non riuscire a ordinarle",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Vedere esempi concreti di persone che ce l’hanno fatta",
        scores: { RELAZIONALE_SOCIALE: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Avere una mappa chiara di tempi, costi e passaggi",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Sapere che quella scelta può migliorare lavoro e prospettive",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Poter analizzare dati, programmi e informazioni precise",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Sentire che quella strada mi rappresenta davvero",
        scores: { CREATIVO_COMUNICATIVO: 2, RELAZIONALE_SOCIALE: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Perdere tempo in un percorso poco spendibile",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Scegliere qualcosa che non sento mio",
        scores: { CREATIVO_COMUNICATIVO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Non rispettare requisiti, scadenze o procedure",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Trovarmi senza metodo e senza continuità",
        scores: { EDUCATIVO_FORMATIVO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Non riuscire a capire se ho davvero le capacità adatte",
        scores: { TECNICO_ANALITICO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Una comparazione chiara tra le alternative",
        scores: { ESPLORATIVO_GUIDATO: 3, NORMATIVO_ISTITUZIONALE: 1 },
      },
      {
        label: "Un consiglio pratico su cosa conviene davvero",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Un confronto umano con qualcuno che mi ascolta",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Un’analisi precisa di dati, sbocchi e programmi",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Una spiegazione semplice, passo dopo passo",
        scores: { EDUCATIVO_FORMATIVO: 3 },
      },
    ],
  },
  {
    ...
    domanda:
      "Quale attività ti assorbe di più senza farti sentire il peso del tempo?",
    options: [
      {
        label: "Organizzare progetti, obiettivi o strategie",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Capire comportamenti, emozioni o relazioni",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Scrivere, comunicare, creare o raccontare",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Risolvere problemi logici o tecnici",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Spiegare qualcosa a qualcuno finché non diventa chiaro",
        scores: { EDUCATIVO_FORMATIVO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Un contesto dinamico, con risultati e responsabilità",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Un contesto umano, dove contano ascolto e fiducia",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Un contesto ordinato, con regole e obiettivi definiti",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Un contesto creativo, dove posso dare forma alle idee",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Un contesto tecnico, dove contano precisione e metodo",
        scores: { TECNICO_ANALITICO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "La possibilità di migliorare ruolo, reddito o carriera",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "La possibilità di lavorare con persone e bisogni reali",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "La possibilità di entrare in un sistema riconosciuto",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "La possibilità di imparare strumenti complessi e utili",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "La possibilità di aiutare altri a imparare o orientarsi",
        scores: { EDUCATIVO_FORMATIVO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        label: "Ricerca",
        scores: { ESPLORATIVO_GUIDATO: 3, TECNICO_ANALITICO: 1 },
      },
    ],
  },
  {
    ...
    domanda:
      "Quando devi studiare qualcosa di nuovo, quale approccio ti viene più naturale?",
    options: [
      {
        label: "Parto dagli obiettivi e cerco di capire a cosa serve",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Cerco spiegazioni chiare e collegamenti con esempi reali",
        scores: { EDUCATIVO_FORMATIVO: 2, RELAZIONALE_SOCIALE: 1 },
      },
      {
        label: "Mi serve un programma ordinato, con tappe precise",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Approfondisco molto, anche oltre quello che è richiesto",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label:
          "Faccio fatica a partire se non capisco bene perché lo sto facendo",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Mi aiutano se sono collegate a un risultato concreto",
        scores: { STRATEGICO_PROFESSIONALE: 2, NORMATIVO_ISTITUZIONALE: 1 },
      },
      {
        label: "Mi tranquillizzano perché danno ordine",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Le rispetto meglio se qualcuno mi accompagna nel percorso",
        scores: { EDUCATIVO_FORMATIVO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Preferisco lavorare con autonomia, purché il tema mi interessi",
        scores: { CREATIVO_COMUNICATIVO: 2, TECNICO_ANALITICO: 1 },
      },
      {
        label: "Mi creano pressione se non ho un piano semplice",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Sapere che ogni passo ha un ritorno pratico",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Avere qualcuno che mi aiuta a non mollare",
        scores: { RELAZIONALE_SOCIALE: 2, EDUCATIVO_FORMATIVO: 1 },
      },
      {
        label: "Avere regole chiare e un calendario ordinato",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Studiare argomenti che stimolano curiosità e ragionamento",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Vedere che il percorso rispecchia davvero chi sono",
        scores: { CREATIVO_COMUNICATIVO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Non vedere risultati abbastanza presto",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Sentirmi solo o poco seguito",
        scores: { RELAZIONALE_SOCIALE: 2, EDUCATIVO_FORMATIVO: 1 },
      },
      {
        label: "Perdermi tra procedure, esami e passaggi tecnici",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Annoiarmi se il percorso è troppo rigido",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Scoprire troppo tardi che non era la scelta giusta",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Ho costruito una possibilità professionale migliore",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Ho imparato a capire meglio persone e relazioni",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Ho ottenuto un titolo utile e riconosciuto",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Ho dato forma a una parte di me che restava ferma",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Ho finalmente chiarito quale strada fa per me",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Essere visto come una persona competente e affidabile",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Essere riconosciuto per empatia e capacità di ascolto",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Avere un titolo valido per procedure, concorsi o avanzamenti",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Essere apprezzato per idee, linguaggio o creatività",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Essere cercato per metodo, precisione e capacità analitica",
        scores: { TECNICO_ANALITICO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Vedere che il percorso mi apre opportunità concrete",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Sentire che ciò che studio mi rende più consapevole",
        scores: { RELAZIONALE_SOCIALE: 2, CREATIVO_COMUNICATIVO: 1 },
      },
      {
        label: "Sapere di aver seguito una strada ordinata e sicura",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Capire problemi complessi con strumenti più forti",
        scores: { TECNICO_ANALITICO: 3 },
      },
      {
        label: "Accorgermi di poter aiutare altri a crescere",
        scores: { EDUCATIVO_FORMATIVO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Un ruolo con più autonomia e responsabilità",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Un lavoro o progetto legato alle persone",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Una posizione stabile, con requisiti chiari",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Un’attività legata a comunicazione, cultura o contenuti",
        scores: { CREATIVO_COMUNICATIVO: 3 },
      },
      {
        label: "Un ambito legato a tecnologia, dati o innovazione",
        scores: { TECNICO_ANALITICO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "una scelta che abbia utilità pratica",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "una scelta che mi faccia sentire più sicuro",
        scores: { ESPLORATIVO_GUIDATO: 3 },
      },
      {
        label: "una scelta riconosciuta e ordinata",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "una scelta che mi somigli di più",
        scores: { CREATIVO_COMUNICATIVO: 2, RELAZIONALE_SOCIALE: 1 },
      },
      {
        label: "una scelta che mi dia strumenti veri",
        scores: { TECNICO_ANALITICO: 2, EDUCATIVO_FORMATIVO: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "E se poi non servisse davvero?",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      { label: "E se non fossi portato?", scores: { ESPLORATIVO_GUIDATO: 3 } },
      {
        label: "E se sbagliassi requisiti o procedura?",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "E se fosse troppo distante da ciò che sono?",
        scores: { CREATIVO_COMUNICATIVO: 2, RELAZIONALE_SOCIALE: 1 },
      },
      {
        label: "E se non riuscissi a capirlo fino in fondo?",
        scores: { TECNICO_ANALITICO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Un consiglio diretto sulle opzioni più utili",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Un ascolto reale, senza giudizio",
        scores: { RELAZIONALE_SOCIALE: 3 },
      },
      {
        label: "Una spiegazione precisa di regole e passaggi",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Una lettura più profonda dei miei interessi",
        scores: { CREATIVO_COMUNICATIVO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Una sintesi logica tra dati, vincoli e possibilità",
        scores: { TECNICO_ANALITICO: 3 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Restare fermo mentre potrei crescere",
        scores: { STRATEGICO_PROFESSIONALE: 3 },
      },
      {
        label: "Scegliere qualcosa che non mi rappresenta",
        scores: { CREATIVO_COMUNICATIVO: 2, ESPLORATIVO_GUIDATO: 1 },
      },
      {
        label: "Perdere occasioni per mancanza di titolo o requisiti",
        scores: { NORMATIVO_ISTITUZIONALE: 3 },
      },
      {
        label: "Non usare le mie capacità per aiutare o guidare altri",
        scores: { EDUCATIVO_FORMATIVO: 3, RELAZIONALE_SOCIALE: 1 },
      },
      {
        label: "Decidere senza avere abbastanza elementi",
        scores: { ESPLORATIVO_GUIDATO: 3, TECNICO_ANALITICO: 1 },
      },
    ],
  },
...
export default function TestFuturoPage() {
  ...
  const handleEmailSubmit = async () => {
    ...
    if (!privacy) {
      setEmailError(
        "Per vedere il risultato completo devi accettare la Privacy Policy."
      );
      return;
    }
  ...
  const handleConfrontoClick = () => {
    const message = `Ciao, ho completato il test “Che tipo di futuro ti somiglia?” su Laurea Smart. Il mio profilo è ${primaryResult.nome} e vorrei confrontare i percorsi e gli atenei più adatti alla mia situazione.`;

    window.open(
      `https://wa.me/393793673257?text=${encodeURIComponent(message)}`,
      "_blank",
      "noopener,noreferrer"
    );
  };
      ...
      {started && completed && !emailConfirmed && (
        ...
        >
          ...
          >
            ...
            il risultato completo e ricevere una copia del profilo da
            info@laureasmart.it.
          </p>
        ...
        <section>
          ...
          <ResultCard title="Profilo secondario">
            <p style={paragraphStyle}>
              Accanto al profilo principale emerge anche una componente:{" "}
              <strong>{secondaryResult.nome}</strong>. Questo significa che la
              tua scelta potrebbe funzionare meglio se tiene insieme direzione
              personale e vincoli pratici.
            </p>
          </ResultCard>
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: 999,
                          background:
                            "linear-gradient(90deg, #1F6FB2, #60C2FF)",
                        }}
                      />
                    </div>
                  </div>
          ...
          <ResultCard title="Il tuo profilo apre più possibilità">
            <p style={paragraphStyle}>
              Il risultato del test non serve a indicare una sola scelta
              obbligata. In base alle tue risposte, l’app Laurea Smart può
              aiutarti a confrontare due o più percorsi e due o più atenei che
              potrebbero essere più adatti a te.
            </p>

            <p style={{ ...paragraphStyle, marginTop: 12 }}>
              Il confronto tiene conto di elementi concreti come tempi, costi,
              modalità di studio, supporto e obiettivi futuri. Così puoi
              orientarti meglio tra le alternative e capire quale strada è più
              coerente con la tua situazione reale.
            </p>

            <button
              type="button"
              onClick={handleConfrontoClick}
              style={{
                width: "100%",
                minHeight: 56,
                borderRadius: 20,
                ...
                background:
                  "linear-gradient(135deg, #1F6FB2 0%, #2F8ED8 54%, #60C2FF 100%)",
                color: "#FFFFFF",
                fontSize: 14.5,
                fontWeight: 950,
                display: "flex",
                ...
                cursor: "pointer",
                marginTop: 18,
                boxShadow: "0 16px 34px rgba(31,111,178,0.34)",
              }}
            >
              <MessageCircle size={18} /> Voglio confrontare le mie possibilità
            </button>
          </ResultCard>
