  ...
  return (
    <div
      ...
      className="
        ...
        rounded-[28px]
        border
        border-[rgba(31,111,178,0.10)]
        bg-white
        p-5
        shadow-[0_14px_36px_rgba(31,111,178,0.10)]
        transition-all
        duration-200
        active:scale-[0.985]
        active:shadow-[0_10px_24px_rgba(31,111,178,0.16)]
        cursor-pointer
      "
    >
      {(title || badge || icon) && (
          ...
          {icon && (
            <div
              className="
                ...
                font-extrabold
                text-[#1F6FB2]
                shadow-[0_8px_18px_rgba(31,111,178,0.14)]
              "
            >
              {icon}
            </div>
